...
export const jutsuList: Jutsu[] = [
    {
        uid: '29252155-82df-4ef9-bb7d-0609f51bb626',
        chakra: 100,
        ...
        image: 'https://vignette1.wikia.nocookie.net/naruto/images/e/eb/Body_Replacement.PNG/revision/latest/scale-to-width-down/320?cb=20150504131249',
        rank: Rank.E,
        restriction: null,
        style: {
            primaryColor: '#968468',
        ...
        users: null,
        info: 'A Kawarimi no Jutsu NEM egy téridő technika, tehát NEM lehet vele téren és időn át kicserélni magad semmivel! Magyarázat lejjebb.',
        functionality: JutsuFunctionality.UTILITY,
    },


    {
        uid: '5e4a3967-5615-4b83-a24b-fc9d8fe4d2d9',
        chakra: 400,
        ...
        jpName: 'Kijigari',
        jutsuRequirements: [],
        image: 'https://i33.servimg.com/u/f33/18/17/45/35/kijiga10.jpg',
        rank: Rank.B,
        restriction: null,
        style: {
            primaryColor: '#a10a02',
    ...
    {
        uid: '17c69735-bd01-4668-a0a7-6322a11f86fa',
        chakra: 500,
        ...
        jutsuRequirements: [],
        image: 'https://i.servimg.com/u/f33/18/17/45/35/juuha_11.jpg',
        rank: Rank.A,
        restriction: null,
        style: { primaryColor: '#048c10',
    ...
    {
        uid: 'e129b9bb-716e-41c9-9cef-5a2ab493725a',
        chakra: 900,
        ...
        jutsuRequirements: [],
        image: 'https://images2.imgbox.com/6b/a8/aamYiwx0_o.png',
    ...
    {
        uid: '1efbaf13-b26d-45b9-a847-c6ac1c30a9b0',
        chakra: 120,
